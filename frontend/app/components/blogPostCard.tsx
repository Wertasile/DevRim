...
const BlogPostCard = ({id, title, releaseDate, summary, content, postUser, comments, likes} : BlogPostProps) => {
  ...
  return (
    <div className='sm:py-5 border-b-[1px] border-solid border-[#979797] flex flex-col p-2 gap-2 cursor-pointer hover:bg-[#211F2D] hover:duration-400 hover:Ease-in-out' onClick={handleNav}>
