...
const ChatMenu = ({Chat} : ChatMenuProps) => {
  ...
  return (
    <div className={`cursor-pointer p-2 ${chat == Chat && ('bg-[#229197] rounded-sm')} border-b-[1px] border-solid border-[#979797] flex flex-row py-2 justify-between`} onClick={() => {setChat(Chat)}}>
        <div>
