...
const ChatMenu = ({Chat} : ChatMenuProps) => {
  ...
  return (
    <div className={`cursor-pointer p-2 ${chat == Chat && ('bg-[#5D64F4] rounded-[5px]')} border-b-[1px] border-solid border-[#353535] flex flex-row py-2 justify-between`} onClick={() => {setChat(Chat)}}>
        <div>
